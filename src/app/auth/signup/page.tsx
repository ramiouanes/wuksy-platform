        ...
        <Card className="p-8 space-y-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="relative">
              ...
              <button
                type="button"
                className="absolute right-3 top-12 text-neutral-400 hover:text-neutral-600"
            ...
            <div className="space-y-3">
              <div className="flex items-start">
                <input
                  ...
                  className="h-4 w-4 mt-1 text-primary-500 focus:ring-primary-500 border-neutral-300 rounded"
                  required
                />
              ...
              <div className="flex items-start">
                ...
                <label htmlFor="dataConsent" className="ml-2 text-sm text-neutral-700">
                  I consent to processing of my health data for personalized analysis
                </label>
              </div>
              ...
              <div className="flex items-start">
                ...
                <label htmlFor="researchConsent" className="ml-2 text-sm text-neutral-700">
                  I consent to anonymous use of my data for research (optional)
                </label>
              </div>
            </div>
